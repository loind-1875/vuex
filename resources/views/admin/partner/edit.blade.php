                        ...
                        <div class="col-sm-12 col-xs-6 m-b-30">
                            <form action="{{ route('partners.update', $partner->id) }}" method="POST">
                                ...
                                <div class="col-sm-12 m-b-30">
                                    ...
                                    <input type="text" class="form-control" name="name" placeHolder="Nhập tên" value="{{ $partner->name }}" required>
                                </div>
                                ...
                                <div class="col-sm-12 m-b-30">
                                    ...
                                    <input id="thumbnail" class="form-control" type="text" name="image" required value="{{ $partner->image }}">
