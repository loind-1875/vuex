                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    @foreach ($recruitments as $index => $recruitment)
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="{{ route('recruitment.edit', $recruitment->id) }}" class="btn btn-primary btn-sm">
                                                    <i class="fa fa-pencil-square-o"></i>
                                                </a>
                                                <form action="{{ route('recruitment.destroy', $recruitment->id) }}" method="POST" style="display: inline-block;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button
