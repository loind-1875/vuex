                        ...
                        <div class="col-sm-12 col-xs-6 m-b-30">
                            <form action="{{ route('recruitment.update', $recruitment->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-12 m-b-30">
                                    ...
                                    <input type="text" class="form-control" name="title" placeHolder="Nhập tiêu đề" value="{{ $recruitment->title }}" required>
                                </div>
                                <div class="col-sm-12 m-b-30">
                                    <h4 class="sub-title">Ảnh bài viết <span>*</span></h4>
                                    <img src="{{ getImage($recruitment->image) }}" alt="" class="img m-b-10">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#summernote').summernote('code', {!! json_encode($recruitment->detail) !!});
