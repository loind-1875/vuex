<footer id="footer" class="m-0">
    <div class="container">
        ...
        <div class="row py-5">
            ...
            <div class="col-lg-3 appear-animation animated fadeIn appear-animation-visible" data-appear-animation="fadeIn" data-appear-animation-delay="1200" data-plugin-options="{'accY': -200}" style="animation-delay: 1200ms;">
                <h4>Giờ làm việc</h4>
            ...
            <div class="row py-4">
                <div class="col-lg-1 d-flex align-items-center justify-content-center justify-content-lg-start mb-2 mb-lg-0">
                    <a href="index.html" class="logo pr-0 pr-lg-3">
                        <img alt="Porto Website Template" src="client/img/logo-footer.png" class="opacity-5" height="33">
                    </a>
                </div>
